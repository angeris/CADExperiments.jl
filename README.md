...
julia --project=CADConstraints -e 'using Pkg; Pkg.add(PackageSpec(url="https://github.com/angeris/CADExperiments.jl.git", subdir="SparseLNNS")); Pkg.test()'

# CADSketchUI demo (pull CADConstraints + SparseLNNS from repo subdirs)
julia --project=CADSketchUI -e 'using Pkg; Pkg.add(PackageSpec(url="https://github.com/angeris/CADExperiments.jl.git", subdir="SparseLNNS")); Pkg.add(PackageSpec(url="https://github.com/angeris/CADExperiments.jl.git", subdir="CADConstraints")); using CADSketchUI; CADSketchUI.run()'
```
